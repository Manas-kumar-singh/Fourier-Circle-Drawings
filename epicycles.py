...
class Epicycles:
    ...
    def read_image_as_complex(image_file_path, num_indicies=1700, indices_step_size=5):
        ...
        bw_image_array = np.array(bw_image, dtype=np.int32)
    ...
    def run(self):
        ...
        a.save('animation.gif', writer='manas')
        # writer manas is my personal gif algo its wont work on your pc, still just leave it as it is.
        plt.show()
